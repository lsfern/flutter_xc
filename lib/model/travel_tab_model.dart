class TravelTabModule {
  String url;
  Params params;
  List<TravelTabItem> tabs;

  TravelTabModule({this.url, this.params, this.tabs});

  TravelTabModule.fromJson(Map<String, dynamic> json) {
    url = json['url'];
    params =
        json['params'] != null ? new Params.fromJson(json['params']) : null;
    if (json['tabs'] != null) {
      tabs = new List<TravelTabItem>();
      json['tabs'].forEach((v) {
        tabs.add(new TravelTabItem.fromJson(v));
      });
    }
  }
...
class TravelTabItem {
  ...
  TravelTabItem({this.labelName, this.groupChannelCode});

  TravelTabItem.fromJson(Map<String, dynamic> json) {
